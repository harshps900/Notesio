...
export default function Login() {
    ...
    const handleLogin = async (formData) => {
        ...
        try {
            ...
            setFormError("Server connection failed. Please try again.");
        } finally {
    ...
    return (
        <div className={`min-h-screen flex items-center justify-center p-4 sm:p-6 transition-colors duration-300 relative overflow-hidden font-sans ${
            ...
            {/* Main Auth Container */}
            <div className={`w-full max-w-4xl rounded-3xl border shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-12 z-10 transition-colors ${
                ...
                <div className="md:col-span-5 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 p-8 sm:p-10 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="my-10 space-y-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-white/15 backdrop-blur-md text-indigo-100">
                            <Sparkles className="w-3.5 h-3.5" />
                            <span>Welcome Back</span>
                        </div>
                        <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight">
                            Access Your Smart Notes.
                        </h2>
                        <p className="text-indigo-100 text-sm leading-relaxed">
                            Sign in to access your custom Kanban boards, synced note rooms, and team shares.
                        </p>
                    </div>

                    {/* Feature Micro List */}
                    <div className="space-y-2.5 pt-4 border-t border-white/20 text-xs font-medium text-indigo-100">
                        <div className="flex items-center gap-2">
                            <CheckCircle2 className="w-4 h-4 text-emerald-300" />
                            <span>Realtime Socket.IO Sync</span>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                <div className="md:col-span-7 p-8 sm:p-12 flex flex-col justify-between">
                    <div className="space-y-6 max-w-sm mx-auto w-full">
                        ...
                        <div className="text-center space-y-2">
                            <h3 className="text-2xl sm:text-3xl font-extrabold tracking-tight">Sign In</h3>
                        ...
                        <Form
                            ...
                            buttonText={isSubmitting ? "Signing In..." : "Sign In to Workspace"}
                            buttonClassName={`w-full py-3.5 rounded-xl font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 shadow-lg shadow-indigo-500/25 transition-all cursor-pointer ${
